      ...
      <section className="py-20 gap-4 flex justify-center relative text-neutral-950">
        ...
        <div className="flex flex-col gap-4 px-4">
          ...
          <p className="max-w-lg mx-auto text-xl">
            At Billy's Barber, our journey began with a deep passion for the art
            of barbering and a strong commitment to serving our community. Our
            story unfolds in a small, modest barbershop where Billy, our
            founder, honed his craft and built lasting relationships with our
            very first clients.
          </p>
          <p className="max-w-lg mx-auto text-xl">
            From those early days, word quickly spread about the quality of
            service and the welcoming atmosphere we offered. As our reputation
            grew, so did our barbershop. We expanded our team of skilled
            barbers, always focusing on delivering precision haircuts and
            classic shaves that left our clients feeling confident and looking
            their best.
          </p>
          <p className="max-w-lg mx-auto text-xl">
            We proudly uphold the same values that guided us from the start:
            exceptional craftsmanship, a warm and inviting atmosphere, and an
            unwavering dedication to helping our clients achieve their desired
            look and maintain their personal style.
          </p>
        </div>
      </section>
      <section className="py-20 gap-4 flex justify-center relative text-neutral-950 bg-red-950 bg-opacity-10">
        <h2 className="text-9xl hidden lg:block absolute top-64 -left-48 text-red-900 rotate-90">
          Our Story
        </h2>
        <div className="flex flex-col gap-4 px-4">
          ...
          <p className="max-w-lg mx-auto text-xl">
            ...
            who understand that a great haircut is more than just a service -
            it's an experience.
          </p>
        </div>
